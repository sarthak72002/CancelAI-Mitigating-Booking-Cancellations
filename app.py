...
def prediction(days_booking, booking_type, special_requests, price_per_room, adults_per_room,
    ...
    if prediction>0.5:
        return f'This booking is more likely to canceled: chances = {round(prediction*100,3)}%'
    else:
        return f'This booking is less likely to get canceled: chances = {round(prediction*100,3)}%'
